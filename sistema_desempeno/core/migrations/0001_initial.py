# Generated by Django 5.1.3 on 2024-12-02 02:05
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='TareaPredefinida',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(max_length=100)),
                ('descripcion', models.TextField()),
                ('periodicidad', models.CharField(choices=[('diario', 'Diario'), ('semanal', 'Semanal'), ('mensual', 'Mensual')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Usuario',
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Administrador'), ('empleado', 'Empleado')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tarea_predefinida', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.tareapredefinida')),
            ],
        ),
    ]
